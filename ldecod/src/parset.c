...
seq_parameter_set_rbsp_t SeqParSet[MAXSPS];	//++ MAXSPS=32
pic_parameter_set_rbsp_t PicParSet[MAXPPS];	//++ MAXPPS=256
...
void ProcessSPS (NALU_t *nalu)
{
  ...
  dp->bitstream->ei_flag = 0;	//++ ei_flag:错误标志，值为0表示无错误
